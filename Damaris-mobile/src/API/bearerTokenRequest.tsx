...
async function fetchPitneyBowesBearerToken(): Promise<void> {
    try {
        ...
        const devKey = 'AkPYtcI6ehbrZabc-ILFUip2sPkpf6e2o_jUXm8NuVw7hCtbUuArYNT-hV_5HufZ';
        ...
        const resp = await fetch(apiUrl, {
            ...
            headers: {
                ...
                Authorization: 'Basic ' + Buffer.from(devCredentials).toString('base64'),
            },
        });
        ...
        if (resp.ok) {
            ...
            console.error('Error fetching Pitney Bowes bearer token:', resp.status, resp.statusText);
        }
    } catch (error) {
